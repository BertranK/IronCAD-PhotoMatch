...
- Preview and adjust the camera in IronCAD; toggle **Image Preview** or adjust photo opacity.
...
2. Pick at least six model points spread across the model. Finish picking to select the first point without a photo location.
