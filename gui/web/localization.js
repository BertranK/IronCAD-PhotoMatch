(function (root) {
  const en = {
    ...
    '대응점 6개 이상':'At least 6 matching points',
    '모델 점 6개 이상을 연결하세요.':'Match at least 6 model points.',
    '모델 점이 직선에 가깝습니다. 넓게 퍼진 점을 선택하세요.':'Model points lie on or near one line. Choose points spread across the model.',
    '평면의 점은 광학 중심 추정을 끄거나 다른 깊이의 점을 추가하세요.':'For planar points, turn off Estimate optical center or add points at different depths.',
